    ...
    <body>
        <nav class="navbar navbar-dark bg-dark mb-4">
            <div class="container-fluid">
                <span class="navbar-brand mb-0 h1 p-3 fw-bold">MessageApp | PT. Kusuma Kreasi Utama</span>
                <div class="d-flex">
                    <a href="/about"><button class="btn btn-outline-success" type="submit">Cara Pemakaian</button></a>
                </div>
            </div>
        </nav>
        ...
        <div class=" min-h-screen sm:items-center sm:pt-0">
            <div class="container">
                <div class="row">
                    ...
                    <a href="/hapus"><button class="btn btn-danger">Hapus Semua Data</button></a>
                    @if(session('success'))
